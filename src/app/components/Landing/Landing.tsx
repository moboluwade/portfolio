...
const Landing = () => {
  ...
  return (
    <div className='px-4 pt-10 md:pt-28 md:px-12 flex flex-col justify-center z-10'>
      <div className=' flex flex-col md:flex-row justify-center gap-12 md:px-8 lg:px-32 w-full'>
